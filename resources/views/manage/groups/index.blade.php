                ...
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-xs-6 text-left">
                            <span class="panel-title">Group List</span>
                        </div>
                        <div class="col-xs-6 text-right">
                            <a href="{{route('groups.create')}}" class="btn btn-sm btn-default pull-right">
                        ...
                        <tbody>
                            @foreach($groups as $group)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="{{route('groups.edit', [$group->id])}}" class="btn btn-xs btn-info">
